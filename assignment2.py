...
print(f"Magnitude of first vector {v1.norm():.2f}")
print(f"Magnitude of second vector {v2.norm():.2f}")
print(f"Dot product of two vectors {v1.dot(v2):.2f}")
...
print(f"Magnitude of first vector {v1_sp.norm():.2f}")
print(f"Magnitude of second vector {v2_sp.norm():.2f}")
print(f"Dot product of two vectors {v1_sp.dot(v2_sp):.2f}")
...
print(f"Area of Triangle 1: {triangle1_area:.2f}")
...
print(f"Area of Triangle 2: {triangle2_area:.2f}")
...
print(f"Area of Triangle 3: {triangle3_area:.2f}")
...
print(f"Area of Triangle 4: {triangle4_area:.2f}")
...
print(f"Triangle 1: Angle between AB and AC = {math.degrees(triangle1_angle_a):2.1f}")
# Angle BA and BC
triangle1_angle_b = math.acos((triangle1_ba.dot(triangle1_bc)) /
(triangle1_ba.norm() * triangle1_bc.norm()))
print(f"Triangle 1: Angle between BA and BC = {math.degrees(triangle1_angle_b):2.1f}")
# Angle CA and CB
triangle1_angle_c = math.acos((triangle1_ca.dot(triangle1_cb)) /
(triangle1_ca.norm() * triangle1_cb.norm()))
print(f"Triangle 1: Angle between CA and CB = {math.degrees(triangle1_angle_c):2.1f}")
...
print(f"Triangle 2: Angle between AB and AC = {math.degrees(triangle2_angle_a):2.1f}")
# Angle BA and BC
triangle2_angle_b = math.acos((triangle2_ba.dot(triangle2_bc)) /
(triangle2_ba.norm() * triangle2_bc.norm()))
print(f"Triangle 2: Angle between BA and BC = {math.degrees(triangle2_angle_b):2.1f}")
# Angle CA and CB
triangle2_angle_c = math.acos((triangle2_ca.dot(triangle2_cb)) /
(triangle2_ca.norm() * triangle2_cb.norm()))
print(f"Triangle 2: Angle between CA and CB = {math.degrees(triangle2_angle_c):2.1f}")
...
print(f"Triangle 3: Angle between AB and AC = {math.degrees(triangle3_angle_a):2.1f}")
# Angle BA and BC
triangle3_angle_b = math.acos((triangle3_ba.dot(triangle3_bc)) /
(triangle3_ba.norm() * triangle3_bc.norm()))
print(f"Triangle 3: Angle between BA and BC = {math.degrees(triangle3_angle_b):2.1f}")
# Angle CA and CB
triangle3_angle_c = math.acos((triangle3_ca.dot(triangle3_cb)) /
(triangle3_ca.norm() * triangle3_cb.norm()))
print(f"Triangle 3: Angle between CA and CB = {math.degrees(triangle3_angle_c):2.1f}")
...
print(f"Triangle 4: Angle between AB and AC = {math.degrees(triangle4_angle_a):2.1f}")
# Angle BA and BC
triangle4_angle_b = math.acos((triangle4_ba.dot(triangle4_bc)) /
(triangle4_ba.norm() * triangle4_bc.norm()))
print(f"Triangle 4: Angle between BA and BC = {math.degrees(triangle4_angle_b):2.1f}")
# Angle CA and CB
triangle4_angle_c = math.acos((triangle4_ca.dot(triangle4_cb)) /
(triangle4_ca.norm() * triangle4_cb.norm()))
print(f"Triangle 4: Angle between CA and CB = {math.degrees(triangle4_angle_c):2.1f}")
